...
protected function setUp()
    {
        ...
        public function testPreschoolTeacher()
        {
            ...
            $this->assertEquals('高能测试', $result['result']['data']['teacher'][0]['orgName']);
            $this->assertEquals('马静', $result['result']['data']['teacher'][0]['name']);
            $this->assertContains('5,cf1a5c26813b', $result['result']['data']['teacher'][0]['thumbMed']);
        ...
        public function  testScoreSort()
        {
            ...
            $result = interfaceFunc::getPostData($this->url, $this->postData);//var_dump($this->http->HttpPost($this->url, json_encode($postdata)));
