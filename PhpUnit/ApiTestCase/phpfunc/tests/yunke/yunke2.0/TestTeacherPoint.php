...
protected function setUp()
    ...
    public function testVideoEdit()
    {
        ...
        $result = interfaceFunc::getPostData($this->url, $this->postData);
        $this->assertEquals('1656', $result['result']['items'][0]['pTime']);
        $this->assertEquals('打点', $result['result']['items'][0]['content']);
        $this->assertEquals('1476', $result['result']['items'][0]['playTimeTmpHandle']);
        $this->assertEquals('00:24:36', $result['result']['items'][0]['playTimeFormat']);
    }
